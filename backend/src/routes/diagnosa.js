...
// Database penyakit tanaman — Expert System berbasis gejala
const DISEASES = [
  {
    id: 1,
    name: 'Bercak Daun (Blast)',
    plant: 'Padi',
    ...
    severity: 'Tinggi',
    recommendations: [
      'Semprotkan fungisida berbahan aktif trisiklazol atau isoprotiolan.',
      'Kurangi pemberian pupuk nitrogen/urea berlebih.',
      'Jaga sirkulasi air pada area lahan.',
      'Gunakan varietas padi tahan blast seperti Inpari 30, Inpari 33.',
      'Lakukan pergiliran tanaman setiap musim.',
    ],
  },
  {
    id: 2,
    ...
    severity: 'Tinggi',
    recommendations: [
      'Semprotkan bakterisida berbahan aktif streptomisin.',
      'Tanam varietas tahan HDB (Inpari 1, Ciherang).',
  ...
  },
  {
    ...
    severity: 'Sedang',
    recommendations: [
      'Semprotkan fungisida mancozeb atau propikonazol.',
      'Tanam varietas jagung yang tahan karat.',
      'Bersihkan sisa-sisa tanaman setelah panen.',
  ...
  },
  {
    ...
    name: 'Layu Fusarium',
    plant: 'Tomat',
    cause: 'Jamur Fusarium oxysporum f.sp. lycopersici',
    ...
    recommendations: [
      ...
      'Berikan Trichoderma sp. pada tanah sebelum tanam.',
      'Perbaiki drainase lahan agar tidak tergenang.',
      'Lakukan rotasi tanaman minimal 3 tahun.',
      'Gunakan benih yang sudah diberi fungisida.',
    ],
  },
  {
    id: 6,
    ...
    severity: 'Tinggi',
    recommendations: [
      'Semprotkan fungisida mankozeb secara berkala.',
      'Panen buah sesegera mungkin saat matang.',
      'Bersihkan buah jatuh dan sisa tanaman.',
  ...
  },
  {
    ...
    plant: 'Cabai',
    cause: 'Begomovirus ditularkan kutu kebul (Bemisia tabaci)',
    symptoms: ['daun menguning dan mengkerut', 'daun menggulung ke atas', 'tanaman kerdil', 'buah kecil dan sedikit', 'kutu kebul pada daun'],
    severity: 'Tinggi',
    recommendations: [
      'Kendalikan kutu kebul dengan insektisida imidakloprid.',
      'Gunakan mulsa perak untuk mengusir kutu kebul.',
      'Pasang perangkap kuning berperekat.',
      'Cabut tanaman terinfeksi segera.',
      'Tanam tanaman penghalang di sekeliling lahan.',
    ],
  },
  {
    id: 8,
    name: 'Karat Daun Kedelai',
    plant: 'Kedelai',
    cause: 'Jamur Phakopsora pachyrhizi',
    ...
    severity: 'Sedang',
    recommendations: [
      'Semprotkan fungisida trifloksistrobin + tebukonazol.',
      'Tanam varietas tahan karat (Anjasmoro).',
      'Lakukan monitoring rutin setiap minggu.',
      'Tanam pada awal musim untuk menghindari puncak serangan.',
  ...
  },
  {
    ...
    recommendations: [
      ...
      'Gunakan varietas tahan wereng (Inpari 13, Ciherang).',
      'Hindari penanaman serempak skala luas.',
      'Jangan gunakan insektisida piretroid (memicu ledakan populasi).',
      'Atur pengairan berselang (intermittent irrigation).',
    ],
  },
  {
    id: 10,
    name: 'Penggerek Batang Jagung',
    plant: 'Jagung',
    cause: 'Hama Ostrinia furnacalis',
    symptoms: ['lubang pada batang', 'serbuk gerek pada batang', 'batang patah', 'tongkol rusak dan berlubang', 'tanaman layu tiba-tiba'],
    severity: 'Sedang',
    recommendations: [
      'Aplikasikan insektisida karbofuran pada pucuk tanaman.',
      'Gunakan perangkap feromon untuk memantau populasi.',
      'Bersihkan sisa tanaman setelah panen.',
      'Tanam serempak dalam satu hamparan.',
      'Pelepasan parasitoid Trichogramma sp. sebagai agen hayati.',
    ],
  },
];

// GET /api/diagnosa/gejala — Daftar semua gejala yang tersedia
...
router.post('/analyze', (req, res) => {
  try {
    ...
    // Hitung skor kecocokan setiap penyakit
    ...
    // Ambil top 3 dengan confidence > 0
    results = results.filter(r => r.confidence > 0).slice(0, 3);

    if (results.length === 0) {
      return res.json({
        diagnosis: null,
        message: 'Tidak ditemukan penyakit yang cocok dengan gejala yang dipilih. Silakan konsultasi dengan pakar pertanian.',
      });
    }
